...
> 	wmw1$pim2<-pim(y~F(x)-1, data=wmw1$dta, link="identity", poset=pairwiseposet, varianceestimator=varianceestimator.H0(), keep.data=TRUE, verbosity=0)
> 	wmw1$pim2
\end{Sinput}
\begin{Soutput}
Call:
...
> 	kw1$pim3<-pim(y~F(x)-1, data=kw1$dta, link="identity", poset=fullposet, force.marginal=TRUE, varianceestimator=varianceestimator.H0(), keep.data=TRUE, verbosity=0)
> 	kw1$pim3
\end{Sinput}
\begin{Soutput}
Call:
...
> 	mss1$pim1<-pim(y~F(x)-1, data=mss1$dta, link="identity", blocking.variables="b", poset=fullposet, force.marginal=TRUE, varianceestimator=varianceestimator.H0(), keep.data=TRUE, verbosity=0)
> 	mss1$pim1
\end{Sinput}
\begin{Soutput}
Call:
...
> 	bh1$pim1<-pim(y~F(x)-1, data=bh1$dta, link="identity", poset=fullposet, varianceestimator=varianceestimator.H0(), keep.data=TRUE, verbosity=0)
> 	bh1$pim1
\end{Sinput}
\begin{Soutput}
Call:
...
> 	jt1$pim1<-pim(y~F(x)-1, data=jt1$dta, link="identity", poset=pairwiseposet, varianceestimator=varianceestimator.H0(), keep.data=TRUE, verbosity=0)
> 	jt1$pim1
\end{Sinput}
\begin{Soutput}
Call:
...
> 	mw1$pim1<-pim(y~F(x)-1, data=mw1$dta, link="identity", poset=pairwiseposet, varianceestimator=varianceestimator.H0(), keep.data=TRUE, verbosity=0)
> 	mw1$pim1
\end{Sinput}
\begin{Soutput}
Call:
pim(frm = y ~ F(x) - 1, data = mw1$dta, link = "identity", poset = pairwiseposet, 
    varianceestimator = varianceestimator.H0(), keep.data = TRUE, 
    verbosity = 0)
